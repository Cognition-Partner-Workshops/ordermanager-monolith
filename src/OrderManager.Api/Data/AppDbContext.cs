...
public class AppDbContext : DbContext
{
    ...
    // InventoryItems DbSet removed — inventory is now managed by the Inventory microservice
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // InventoryItem entity configuration removed — inventory is now managed by the Inventory microservice
    }
}
