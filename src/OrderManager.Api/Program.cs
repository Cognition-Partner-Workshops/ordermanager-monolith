...
// Register HTTP client for inventory microservice
var inventoryServiceUrl = builder.Configuration.GetValue<string>("InventoryService:BaseUrl") ?? "http://localhost:5100";
