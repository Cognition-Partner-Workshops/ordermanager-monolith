...
public class InventoryApiClient
{
    ...
    public virtual async Task<List<InventoryItem>> GetAllInventoryAsync()
    {
    ...
    public virtual async Task<InventoryItem?> GetInventoryByProductIdAsync(int productId)
    {
    ...
    public virtual async Task<InventoryItem> RestockAsync(int productId, int quantity)
    {
    ...
    public virtual async Task<InventoryItem> DeductStockAsync(int productId, int quantity)
    {
    ...
    public virtual async Task<List<InventoryItem>> GetLowStockItemsAsync()
    {
