...
public class OrderServiceTests
{
    ...
    private static Mock<InventoryApiClient> CreateMockInventoryClient()
    {
        var mockHandler = new Mock<HttpMessageHandler>();
        var httpClient = new HttpClient(mockHandler.Object) { BaseAddress = new Uri("http://localhost:5199") };
        return new Mock<InventoryApiClient>(httpClient);
    }
